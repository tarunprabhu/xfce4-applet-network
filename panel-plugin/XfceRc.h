...
// Foreward declaration from libxfce4util/xfce-rc.h
struct _XfceRc;
...
public:
  ...
  // Read functions
  std::string read(const std::string&, const std::string&) const;
  ...
  std::string read_untranslated(const std::string&, const std::string&) const;
...
public:
  static Rc& simple_open(const std::string&, bool);
